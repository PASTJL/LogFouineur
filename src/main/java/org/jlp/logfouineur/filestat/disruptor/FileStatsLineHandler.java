...
/**
 * The Class FileStatsLineHandler.
 */
public class FileStatsLineHandler implements EventHandler<FileStatEvent> {
	...
	/**
	 * Instantiates a new file stats line handler.
	 */
	public FileStatsLineHandler() {
		...
		pas=  Double.parseDouble(DiagFileStats.fileStatProps.getProperty("filestat.steppercent", "0.0").replaceAll(",", "."));
		System.out.println("FileStatsLineHandler : DiagFileStats.nbThreads ====>" + DiagFileStats.nbThreads);
	}
